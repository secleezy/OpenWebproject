          ...
          <table style={{display: 'inline-block'}}>
            ...
            <tr>
              <td style={{width: '250px', textAlign:'left', fontSize: '12px', verticalAlign : 'top'}}>
                <b>EMAIL <sub style={{color: 'Blue', fontSize: '18px'}}>*</sub></b><br/>
                ...
                <b>PASSWORD Required Field <sub style={{color: 'Blue', fontSize: '18px'}}>*</sub></b><br/>
                ...
                <b>CONFIRM PASSWORD Required Field <sub style={{color: 'Blue', fontSize: '18px'}}>*</sub></b><br/>
...
※ If you do not accept these terms, you will not be able to create an account with us.</div>
